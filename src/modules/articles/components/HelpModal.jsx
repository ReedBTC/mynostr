      ...
      >
        <div className="bg-neutral-900 border border-neutral-800 rounded-lg w-full max-w-2xl max-h-[80vh] flex flex-col">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-neutral-800">
            <h2 className="text-sm font-semibold text-neutral-200">How to Use {APP_NAME}</h2>
            <button
              onClick={onClose}
          ...
          <div className="overflow-y-auto px-6 py-5 space-y-6 text-sm text-neutral-400 leading-relaxed">
            ...
            <section className="space-y-2">
              <h3 className="text-neutral-200 font-semibold">What is {APP_NAME}?</h3>
              <p>
                {APP_NAME} is a single-purpose tool for publishing long-form articles to Nostr (NIP-23 Kind 30023 events).
            ...
            <section className="space-y-2">
              ...
              <p>
                ...
                If the file has YAML frontmatter (from a previous {APP_NAME} export), all metadata fields will be auto-populated.
              </p>
              <p>
            ...
            <section className="space-y-2">
              ...
              <p>
                When a source name is provided, {APP_NAME} automatically prepends an italicized attribution line to your content before signing:
            ...
            <section className="space-y-2">
              ...
              <p>
                ...
                {APP_NAME} reads your Kind 10002 relay list and publishes to your write relays. If none are found, it falls
            ...
            <section className="space-y-2">
              ...
              <p>
                ...
                Uploading it back into {APP_NAME} restores everything exactly as it was.
              </p>
              <p>
