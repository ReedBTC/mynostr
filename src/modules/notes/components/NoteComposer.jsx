  ...
  return (
    <div className="flex-1 overflow-y-auto overflow-x-hidden">
      <div className="max-w-[400px] mx-auto px-4 py-5">
        ...
        {/* Action row — Import/Export disclosure on the left (normally
            closed; the paste-id field used to be inline at the top
            which read as a required field), Clear pinned to the right. */}
